...
return new class extends Migration
{
    ...
    {
        Schema::create('insiden_layanan_syarat', function (Blueprint $table) {
            $table->id();
            $table->foreignId('insiden_layanan_id')
                ->constrained('insiden_layanan')
                ->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('insiden_layanan_syarat');
    }
};
