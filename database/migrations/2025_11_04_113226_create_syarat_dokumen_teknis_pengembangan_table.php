...
return new class extends Migration
{
    ...
    {
        Schema::create('syarat_dokumen_teknis_pengembangan', function (Blueprint $table) {
            ...
            $table->foreign(
                ...
                'fk_syarat_dokumen_teknis_pengembangan_permintaan_layanan_syarat'
            )->references('id')->on('permintaan_layanan_syarat');

            $table->foreign(
                'perubahan_layanan_syarat_id',
                'fk_syarat_dokumen_teknis_pengembangan_perubahan_layanan_syarat'
            )->references('id')->on('perubahan_layanan_syarat');

            $table->foreign(
                'insiden_layanan_syarat_id',
                'fk_syarat_dokumen_teknis_pengembangan_insiden_layanan_syarat'
            ...
            $table->string('dokumen_type')->nullable()->comment('tipe dokumen teknis pengembangan');
    ...
    {
        Schema::dropIfExists('syarat_dokumen_teknis_pengembangan');
    }
};
