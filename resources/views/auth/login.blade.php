<x-guest-layout>
    ...
    <div>
        ...
        <div <div
            class="relative flex h-screen items-center justify-center bg-cover bg-center bg-no-repeat px-6 py-8 dark:bg-[#060818] sm:px-16 overflow-hidden box-border">

            <div
                class="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:flex-row lg:gap-10 xl:gap-0 max-h-[calc(100vh-4rem)]">
                ...
                <div
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        <div class="mb-10">
                            ...
                            <p class="text-base font-bold leading-normal text-white-dark">Masukan email and password
                                untuk login</p>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <x-text-input id="Password" type="password" name="password"
                                        autocomplete="current-password" class="ps-10" placeholder="Enter Password" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path opacity="0.5"
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                form.addEventListener('submit', function(e) {
                    ...
                    const recaptcha = document.querySelector('.g-recaptcha-response')?.value.trim();

                    if (!email || !password) {
                        Swal.fire({
                            icon: 'warning',
                            title: 'Field Kosong!',
                            text: 'Silakan isi email dan password sebelum login.',
