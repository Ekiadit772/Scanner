            ...
            <div
                ...
                <div
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        <div class="mb-10">
                            <h1 class="text-3xl font-extrabold  !leading-snug text-[#056BDA] md:text-4xl">Reset Password
                            </h1>
                            <!-- Session Status -->
                            <x-auth-session-status class="mb-4" :status="session('status')" />
                            <p class="text-base font-bold leading-normal text-white-dark">Masukan password baru</p>
                        </div>
                        <form method="POST" action="{{ route('password.store') }}" class="space-y-5 dark:text-white">
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <x-text-input id="email" class="ps-10" type="email" name="email"
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <x-text-input id="password" class="ps-10" type="password" name="password" required
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <x-text-input id="password_confirmation" class="ps-10" type="password"
