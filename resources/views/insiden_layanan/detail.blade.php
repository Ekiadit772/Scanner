    ...
    <div class="panel lg:row-span-3 mt-8">
        <div class="mb-5">
            <form class="space-y-5 px-0 sm:px-10" id="formManajemeninsiden" enctype="multipart/form-data">
                ...
                <input type="hidden" name="" id="idManajemen" value="{{ $insiden->id }}">
                ...
                <div class="flex flex-col sm:flex-row sm:space-x-6">
                    <div class="flex flex-col sm:flex-row sm:items-center mb-3 sm:mb-0 w-full sm:w-1/2">
                        ...
                        <div class="flex-1">
                            <x-text-input id="telepon_pemohon" class="w-full" type="text" name="telepon_pemohon"
                                :value="old('telepon_pemohon', $insiden->telepon_pemohon)" placeholder="Masukkan Unit Kerja" readonly />
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center mb-3 sm:mb-0 w-full sm:w-1/2">
                        ...
                        <div class="flex-1">
                            <x-text-input id="email_pemohon" class="w-full" type="text" name="email_pemohon"
                                :value="old('email_pemohon', $insiden->email_pemohon)" placeholder="Masukan email_pemohon" readonly />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="lg:col-span-2">
                        <div class="flex flex-col lg:flex-row lg:space-x-6 mb-3">
                            <div class="flex flex-col sm:flex-row sm:items-center w-full">
                                <label class="sm:w-32 text-sm font-medium">No Antrian</label>
                                <div class="flex-1">
                                    <x-text-input id="no_antrian" class="w-full" type="text" name="no_antrian"
                                        :value="old('no_antrian', $insiden->no_antrian)" readonly />
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center w-full mt-3 lg:mt-0">
                                ...
                                <div class="flex-1">
                                    <x-text-input id="tanggal" class="w-full" type="date" name="tanggal"
                                        :value="old('tanggal', now()->toDateString())" readonly />
                                </div>
                            </div>
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center mb-3 mt-3">
                            <label class="sm:w-32 text-sm font-medium">Penyedia Layanan</label>
                            <div class="flex-1">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center mb-3 mt-3">
                            <label class="sm:w-32 text-sm font-medium">Bidang</label>
                            <div class="flex-1">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center mb-3 mt-3">
                            <label class="sm:w-32">Nama Layanan</label>
                            <div class="flex-1">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center mb-3">
                            <label for="keluhan" class="sm:w-32">Keluhan</label>
                            <div class="flex-1">
                                <textarea id="keluhan" class="w-full form-textarea" readonly>{{ $insiden->keluhan }}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-start mb-3">
                                ...
                                <div class="flex-1">
                                    <textarea id="penanganan_insiden" name="penanganan_insiden" class="w-full form-textarea"
                                         readonly>{{ old('penanganan_insiden', $insiden->penanganan_insiden) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-start mb-3">
                                ...
                                <div class="flex-1">
                                    <textarea id="perangkat_yang_diperlukan" name="perangkat_yang_diperlukan" class="w-full form-textarea"
                                         readonly>{{ old('perangkat_yang_diperlukan', $insiden->perangkat_yang_diperlukan) }}</textarea>
                                </div>
                            </div>
                        @endif

                        {{-- PENELUSURAN / STATUS PENANGANAN --}}
                        @if (in_array($currentStatus, ['penelusuran', 'selesai']))
                            <div class="items-center mb-5 mt-6">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-start mb-3">
                                ...
                                <div class="flex-1">
                                    <textarea id="keterangan_pelaksanaan" name="keterangan_pelaksanaan"
                                        class="w-full form-textarea"readonly>{{ old('keterangan_pelaksanaan', $insiden->keterangan_pelaksanaan) }}</textarea>
                                </div>
                            </div>
                        @endif
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadPersyaratan(layananId) {
                let insidenId = $('#idManajemen').val();

                let $list = $('#persyaratan_list');
                $list.html('<p class="text-gray-400 italic">Memuat persyaratan...</p>');
                if (!layananId) return;

                $.getJSON(`{{ url('/api/insiden-layanan/get-syarat') }}/${layananId}?insiden_id=${insidenId}`,
                    function(data) {
                        if (!data.length) {
                            $list.html(
