<x-app-layout>
    <x-breadcrumb :items="[['label' => 'Pelaporan'], ['label' => 'Edit Insiden Layanan']]" />
        ...
        <div class="mb-5">
            <form class="space-y-5 px-0 sm:px-10" id="formManajemenInsiden" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center mb-3 sm:mb-0 w-full sm:w-1/2">
                        ...
                        <div class="flex-1">
                            <x-text-input id="nip_pemohon" class="w-full" type="number" name="nip_pemohon"
                                value="{{ old('nip_pemohon', $insiden->nip_pemohon) }}" required
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center mb-3 sm:mb-0 w-full sm:w-1/2">
                        ...
                        <div class="flex-1">
                            <x-text-input id="unit_kerja_pemohon" class="w-full" type="text"
                                name="unit_kerja_pemohon" :value="old('unit_kerja_pemohon', $insiden->unit_kerja_pemohon)" placeholder="Masukkan Unit Kerja" />
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center mb-3 sm:mb-0 w-full sm:w-1/2">
                        ...
                        <div class="flex-1">
                            <x-text-input id="jabatan_pemohon" class="w-full" type="text" name="jabatan_pemohon"
                                :value="$insiden->jabatan_pemohon" required placeholder="Masukkan Nama Instansi" />
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center mb-3 sm:mb-0 w-full sm:w-1/2">
                        ...
                        <div class="flex-1">
                            <x-text-input id="email_pemohon" class="w-full" type="email" name="email_pemohon"
                                :value="old('email_pemohon', $insiden->email_pemohon)" placeholder="Masukan Email Pemohon" />
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center mb-3">
                    ...
                    <div class="flex-1">
                        <textarea id="keluhan" class="w-full form-textarea" type="text" name="keluhan">{{ $insiden->keluhan }}</textarea>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#nama_layanan').select2({
                ajax: {
                    url: `{{ url('/api/insiden-layanan/get-layanan') }}/{{ $insiden->penyedia_layanan_id }}`,
                    dataType: 'json',
                    delay: 250,
        ...
        // `);
            ...
            $('#formManajemenInsiden').submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    url: `{{ url('/api/insiden-layanan/update') }}/${idManajemen}`,
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
