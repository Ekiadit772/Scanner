<x-app-layout>
    ...
    <div class="flex flex-col sm:flex-row justify-between gap-3">
        <x-breadcrumb :items="[['label' => 'Pelaporan'], ['label' => 'Riwayat Insiden Layanan']]" />
        {{-- <a href="{{ route('katalog-layanan.create') }}" class="btn btn-primary btn-sm">Tambah</a> --}}
    </div>

    <div class="grid grid-cols-2 sm:grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4 mt-5">
        @if ($activeStatus->contains(15))
        ...
        @if ($activeStatus->contains(16))
            <div class="bg-white shadow rounded-xl p-5 flex items-center gap-4 border">
                ...
                <div>
                    <h4 class="text-base font-semibold text-gray-700">Penugasan</h4>
                    <p id="summary-verifikasi" class="text-3xl font-bold">0</p>
                    <p class="text-xs text-gray-500">Data yang dalam penugasan</p>
                </div>
            </div>
        @endif

        @if ($activeStatus->contains(17))
            <div class="bg-white shadow rounded-xl p-5 flex items-center gap-4 border">
                ...
                <div>
                    <h4 class="text-base font-semibold text-gray-700">Penanganan</h4>
                    <p id="summary-proses" class="text-3xl font-bold">0</p>
                    <p class="text-xs text-gray-500">Data dalam penanganan</p>
                </div>
            </div>
        @endif

        @if ($activeStatus->contains(18))
        <div class="bg-white shadow rounded-xl p-5 flex items-center gap-4 border">
    ...
    <div class="panel mt-6">
        <h5 class="font-semibold text-lg dark:text-white-light mb-4">Data Riwayat Insiden Layanan</h5>

        <div class="flex flex-wrap gap-3 mb-4">
            <input type="hidden" value="insiden_layanan" id="jenis_transaksi">
            <div class="w-64">
    ...
    @include('components.js.insidenLayanan')
</x-app-layout>
