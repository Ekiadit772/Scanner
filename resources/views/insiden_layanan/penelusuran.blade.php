<x-app-layout>
    ...
    <div class="flex flex-col sm:flex-row justify-between gap-3">
        <x-breadcrumb :items="[['label' => 'Manajmen Insiden'], ['label' => 'Penelusuran dan Status Penanganan Insiden']]" />
    ...
    <div x-data="multipleTable">
        <div class="panel mt-6">
            <h5 class="font-semibold text-lg dark:text-white-light mb-4">Data Penelusuran dan Status Penanganan Insiden</h5>
    ...
    @include('components.js.insidenLayananVerifikasi')
</x-app-layout>
