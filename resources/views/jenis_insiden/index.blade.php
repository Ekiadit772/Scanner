<x-app-layout>
    ...
    <div class="flex flex-col sm:flex-row justify-between gap-4 mb-6">
        <x-breadcrumb :items="[['label' => 'Manajemen Data Master & Referensi'], ['label' => 'Jenis Insiden']]" />
    </div>
    ...
    <div x-data="multipleTable">
        <div class="panel mt-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4">
                <h5 class="font-semibold text-lg dark:text-white-light mb-4">Daftar Jenis Insiden</h5>
                @can('Jenis Insiden;Tambah')
                    {{-- ==== Modal Jenis Insiden ==== --}}
                    <x-modals modal-id="modalJenisInsiden" title-id="modal-title" title-default="Tambah Jenis Insiden"
                        title-edit="Edit Jenis Insiden" form-id="JenisInsidenForm" error-box-id="formError"
                        open-event="open-modal" edit-event="open-edit-modal" close-event="close-jenis-insiden-modal"
                        button-label="Tambah Jenis Insiden">
                        <form x-ref="JenisInsidenForm" class="space-y-5" id="JenisInsidenForm" method="POST"
                            x-data="JenisInsidenFormHandler" @submit.prevent="submitForm">
                            @csrf
                            <div>
    ...
    @include('components.js.jenisInsiden')
</x-app-layout>
