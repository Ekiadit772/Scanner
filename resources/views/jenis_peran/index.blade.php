<x-app-layout>
    ...
    <div x-data="multipleTable">
        <div class="panel mt-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4">
                <h5 class="font-semibold text-lg dark:text-white-light mb-4">Daftar Jenis Peran</h5>
                @can('Jenis Peran;Tambah')
                    {{-- ==== Modal Jenis Peran ==== --}}
                    <x-modals modal-id="modalJenisPeran" title-id="modal-title" title-default="Tambah Jenis Peran"
                        title-edit="Edit Jenis Peran" form-id="JenisPeranForm" error-box-id="formError"
                        submit-handler="JenisPeranFormHandler" open-event="open-modal" edit-event="open-edit-modal"
                        close-event="close-modal" button-label="Tambah Jenis Peran">

                        <form x-ref="JenisPeranForm" class="space-y-5" id="JenisPeranForm" method="POST"
                            x-data="JenisPeranFormHandler" @submit.prevent="submitForm">
                            @csrf
                            ...
                            <div>
                                <label for="peran">Peran / Tugas</label>
                                <textarea id="peran" name="peran"
                                    ...
                                    rows="6" placeholder="Masukkan peran / tugas">{{ old('peran') }}</textarea>
    ...
    @include('components.js.jenisPeran')
</x-app-layout>
