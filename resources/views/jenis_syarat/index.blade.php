<x-app-layout>
    ...
    <div class="flex flex-col sm:flex-row justify-between gap-4 mb-6">
        <x-breadcrumb :items="[['label' => 'Manajemen Data Master & Referensi'], ['label' => 'Jenis Syarat']]" />
    </div>
    ...
    <div x-data="multipleTable">
        <div class="panel mt-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4">
                <h5 class="font-semibold text-lg dark:text-white-light mb-4">Daftar Jenis Syarat</h5>
                @can('Jenis Syarat;Tambah')
                    <x-modals modal-id="modalJenisSyarat" title-id="modal-title" title-default="Tambah Jenis Syarat"
                        title-edit="Edit Jenis Syarat" form-id="JenisSyaratForm" error-box-id="formError"
                        open-event="open-modal" edit-event="open-edit-modal" close-event="close-jenis-syarat-modal"
                        button-label="Tambah Jenis Syarat">

                        <form x-ref="JenisSyaratForm" class="space-y-5" id="JenisSyaratForm" method="POST"
                            x-data="JenisSyaratFormHandler" @submit.prevent="submitForm">
                            @csrf
                            <div>
                            ...
                            <div>
                                ...
                                <x-text-input id="kelompok" class="block mt-1 w-full" type="text" name="kelompok"
                                    :value="old('kelompok')" required autocomplete="kelompok" placeholder="Masukkan kelompok" />
                                <x-input-error :messages="$errors->get('kelompok')" class="mt-2" />
                            </div>

                            <div>
                                <label for="keterangan">keterangan</label>
                                <textarea id="keterangan" class="form-textarea" type="text" name="keterangan"></textarea>
    ...
    @include('components.js.jenisSyarat')
</x-app-layout>
