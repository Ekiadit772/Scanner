<x-app-layout>
    ...
    <div class="flex flex-col sm:flex-row justify-between gap-4 mb-6">
        <x-breadcrumb :items="[['label' => 'Manajemen Data Master & Referensi'], ['label' => 'Kategori Perubahan']]" />
    </div>
    ...
    <div x-data="multipleTable">
        <div class="panel mt-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4">
                <h5 class="font-semibold text-lg dark:text-white-light mb-4">Daftar Kategori Perubahan</h5>
                @can('Kategori Perubahan;Tambah')
                    {{-- ==== Modal Kategori Perubahan ==== --}}
                    <x-modals modal-id="modalKategoriPerubahan" title-id="modal-title"
                        title-default="Tambah Kategori Perubahan" title-edit="Edit Kategori Perubahan"
                        form-id="KategoriPerubahanForm" error-box-id="formError" open-event="open-modal"
                        edit-event="open-edit-modal" close-event="close-kategori-perubahan-modal"
                        button-label="Tambah Kategori Perubahan">

                        <form x-ref="KategoriPerubahanForm" class="space-y-5" id="KategoriPerubahanForm" method="POST"
                            x-data="KategoriPerubahanFormHandler" @submit.prevent="submitForm">
                            @csrf
                            <div>
    ...
    @include('components.js.kategoriPerubahan')
</x-app-layout>
