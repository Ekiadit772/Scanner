...
<body x-data="main"
    class="antialiased relative font-nunito text-sm font-normal overflow-x-hidden horizontal full ltr"
    ...
    <script>
        function initAutoNumericUang() {
            if (typeof AutoNumeric === 'undefined') {
                console.error('AutoNumeric belum terload. Cek file assets/js/autonumeric.min.js');
                return;
            }

            document.querySelectorAll('.uang').forEach(function(el) {
                if (el.AutoNumericRef) return;

                el.AutoNumericRef = new AutoNumeric(el, {
                    digitGroupSeparator: '.',
                    decimalCharacter: ',',
                    decimalPlaces: 0,
        ...
        document.addEventListener('DOMContentLoaded', initAutoNumericUang);
    </script>
