<x-app-layout>
    <x-breadcrumb :items="[['label' => 'Manajemen Permintaan Layanan'], ['label' => 'Permintaan Layanan']]" />
    @if ($errors->any())
        <div class="mb-4">
        ...
        <div class="mb-5">
            <form class="space-y-5 px-0 sm:px-10" id="formManajemenPermintaan" enctype="multipart/form-data">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center mb-3">
                    ...
                    <div class="flex-1">
                        <textarea id="deskripsi_spek" class="w-full form-textarea" type="text" name="deskripsi_spek"></textarea>
        ...
        $(document).ready(function() {
            ...
            $('#perangkat_daerah_user').select2({
                ajax: {
                    ...
                    // 👇 tambahkan ini untuk detect error
            ...
            $('#formManajemenPermintaan').on('submit', function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    url: `{{ url('/api/permintaan-layanan/store') }}`,
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(res) {
                        Swal.fire({
                            ...
                            window.location.href = `{{ url('/permintaan-layanan') }}`;
                        });
                    },
                    error: function(xhr) {
