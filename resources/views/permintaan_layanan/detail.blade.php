<x-app-layout>
    ...
    <div class="panel lg:row-span-3 mt-8">
        <div class="mb-5">
            <form class="space-y-5 px-0 sm:px-10" id="formManajemenPermintaan" enctype="multipart/form-data">
                ...
                <input type="hidden" name="" id="idManajemen" value="{{ $permintaan->id }}">
    ...
    <div id="modalSyarat" class="hidden fixed inset-0 z-50 bg-black/60 overflow-y-auto">
        <div class="flex justify-center">
            <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-2xl my-10">
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadPersyaratan(layananId) {
                let permintaanId = $('#idManajemen').val();
                ...
                $.getJSON(
                    `{{ url('/api/permintaan-layanan/get-syarat') }}/${layananId}?permintaan_id=${permintaanId}`,
                    function(data) {
                        console.log(data);
