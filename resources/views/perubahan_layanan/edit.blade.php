<x-app-layout>
    <x-breadcrumb :items="[['label' => 'Pelaporan'], ['label' => 'Edit perubahan Layanan']]" />
    ...
    <div class="panel lg:row-span-3 mt-8">
        <div class="mb-5">
            <form class="space-y-5 px-0 sm:px-10" id="formManajemenPerubahan" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center w-full lg:w-1/4">
                        ...
                        <div class="flex-1">
                            <x-text-input id="tanggal" class="w-full" type="date" name="tanggal"
                                :value="old('tanggal', $perubahan->tanggal)" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center mb-3 sm:mb-0 w-full sm:w-1/2">
                        ...
                        <div class="flex-1">
                            <x-text-input id="unit_kerja_pemohon" class="w-full" type="text"
                                name="unit_kerja_pemohon" :value="old('unit_kerja_pemohon', $perubahan->unit_kerja_pemohon)" placeholder="Masukkan Unit Kerja" />
                            <x-input-error :messages="$errors->get('unit_kerja_pemohon')" class="mt-2" />
                        </div>
                    </div>

                    <div class="flex flex-col sm:flex-row sm:items-center mb-3 sm:mb-0 w-full sm:w-1/2">
                        <label for="jabatan_pemohon" class="sm:w-20 mt-1 text-sm font-medium">Jabatan</label>
                        <div class="flex-1">
                            <x-text-input id="jabatan_pemohon" class="w-full" type="text" name="jabatan_pemohon"
                                :value="old('jabatan_pemohon', $perubahan->jabatan_pemohon)" placeholder="Masukan Jabatan" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center mb-3 sm:mb-0 w-full">
                        ...
                        <div class="flex-1">
                            <x-text-input id="judul_perubahan" class="w-full" type="text" name="judul_perubahan"
                                :value="old('judul_perubahan', $perubahan->judul_perubahan)" placeholder="Masukkan judul perubahan" />
                ...
                <div class="flex flex-col sm:flex-row sm:items-center mb-3 sm:mb-0 w-full">
                    ...
                    <div class="flex-1">
                        <textarea id="deskripsi" name="deskripsi" rows="3"
                            ...
                            placeholder="Masukkan deskripsi singkat">{{ old('deskripsi', $perubahan->deskripsi) }}</textarea>
                    ...
                    <div class="flex items-center gap-6 flex-1">
                        <label class="flex items-center gap-2">
                            <input type="radio" name="is_in_peta_spbe" value="1" class="form-checkbox"
                                {{ old('is_in_peta_spbe', $perubahan->is_in_peta_spbe) == '1' ? 'checked' : '' }}>
                            Ya
                        </label>

                        <label class="flex items-center gap-2">
                            <input type="radio" name="is_in_peta_spbe" value="0" class="form-checkbox"
                                {{ old('is_in_peta_spbe', $perubahan->is_in_peta_spbe) == '0' ? 'checked' : '' }}>
                            Tidak
                        </label>
                    </div>
                </div>
                    ...
                    <div class="flex items-center gap-6 flex-1">
                        <label class="flex items-center gap-2">
                            <input type="radio" name="jenis_perubahan" value="Minor" class="form-checkbox"
                                {{ old('jenis_perubahan', $perubahan->jenis_perubahan) == 'Minor' ? 'checked' : '' }}>
                            Minor
                        </label>

                        <label class="flex items-center gap-2">
                            <input type="radio" name="jenis_perubahan" value="Mayor" class="form-checkbox"
                                {{ old('jenis_perubahan', $perubahan->jenis_perubahan) == 'Mayor' ? 'checked' : '' }}>
                            Mayor
                        </label>

                        <label class="flex items-center gap-2">
                            <input type="radio" name="jenis_perubahan" value="Darurat" class="form-checkbox"
                                {{ old('jenis_perubahan', $perubahan->jenis_perubahan) == 'Darurat' ? 'checked' : '' }}>
                            Darurat
                        </label>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center mb-3 sm:mb-0 w-full">
                    ...
                    <div class="flex-1">
                        <textarea id="latar_belakang" name="latar_belakang" rows="3"
                            class="w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm"
                            placeholder="Masukkan latar belakang / alasan perubahan">{{ old('latar_belakang', $perubahan->latar_belakang) }}</textarea>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center mb-3 sm:mb-0 w-full">
                    ...
                    <div class="flex-1">
                        <x-text-input id="tujuan_perubahan" class="w-full" type="text" name="tujuan_perubahan"
                            :value="old('tujuan_perubahan', $perubahan->tujuan_perubahan)" placeholder="Masukkan tujuan perubahan" />
                    ...
                    <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="date" name="jadwal_mulai"
                                value="{{ old('jadwal_mulai', $perubahan->jadwal_mulai) }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="jadwal_selesai"
                                value="{{ old('jadwal_selesai', $perubahan->jadwal_selesai) }}"
                                class="w-full border-gray-300 rounded-md shadow-sm text-sm">
                        </div>
                    </div>
                </div>
                ...
                <!-- Waktu Downtime -->
                <div x-data="{
                    ada: {{ $perubahan->is_downtime ? 'true' : 'false' }},
                    tidakAda: {{ $perubahan->is_downtime ? 'false' : 'true' }}
                }" class="flex flex-col sm:flex-row sm:items-start mb-3 w-full">
                    ...
                    <div class="flex-1 flex flex-col gap-3">
                        <div class="flex items-center gap-6">
                            ...
                            <!-- HIDDEN INPUT AGAR DIKIRIM KE BACKEND -->
                            ...
                            <label class="flex items-center gap-2">
                                ...
                                <input type="text" name="downtime"
                                    value="{{ old('downtime', $perubahan->downtime) }}" :disabled="!ada"
                                    class="w-full border-gray-300 rounded-md shadow-sm text-sm">
                            </label>
    ...
    <script>
        $(document).ready(function() {
                ...
                .then(res => {
                    ...
                    data.forEach(item => {
                        ...
                        if (isAktif == 1) {
                            ...
                            let isChecked = selectedArea.includes(hashedId) ? 'checked' : '';

                            container.innerHTML += `
                    <label class="flex items-center gap-2">
                        <input type="checkbox" name="area_perubahan_ids[]" 
                               value="${hashedId}" ${isChecked} class="form-checkbox">
                        ${nama}
                    </label>
                `;
                        }
            ...
            $('#nama_layanan').select2({
                ajax: {
                    url: `{{ url('/api/perubahan-layanan/get-layanan') }}/{{ $perubahan->penyedia_layanan_id }}`,
                    dataType: 'json',
                    delay: 250,
            ...
            // $('#formManajemenPerubahan').submit(function(e) {
            //     e.preventDefault();
            ...
            //     $.ajax({
            //         url: `{{ url('/api/perubahan-layanan/update') }}/${idManajemen}`,
            //         type: 'POST',
            //         data: formData,
            //         processData: false,
            //         contentType: false,
