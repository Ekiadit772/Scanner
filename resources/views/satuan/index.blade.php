<x-app-layout>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <x-breadcrumb :items="[['label' => 'Manajemen Data Master & Referensi'], ['label' => 'Referensi'], ['label' => 'Satuan']]" />
    </div>
    ...
    <div x-data="multipleTable">
        <div class="panel mt-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4">
                <h5 class="font-semibold text-lg dark:text-white-light">Daftar Satuan</h5>

                @can('Satuan;Tambah')
                    <x-modals modal-id="modalSatuan" title-id="modal-title" title-default="Tambah Satuan"
                        title-edit="Edit Satuan" form-id="SatuanForm" error-box-id="formError" open-event="open-modal"
                        edit-event="open-edit-modal" close-event="close-satuan-modal" button-label="Tambah Satuan">
                        <form x-ref="SatuanForm" class="space-y-5" id="SatuanForm" method="POST"
                            x-data="SatuanFormHandler" @submit.prevent="submitForm">
                            @csrf
                            <div>
